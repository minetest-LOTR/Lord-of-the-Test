-- Register Shields
minetest.register_tool("curwe:shield_wood", {
	description = "Training Shield",
	inventory_image = "curwe_inv_shield_wood.png",
	groups = {armor_head=2.5, armor_heal=0, armor_use=2000, armor_healing=0, physics_speed=0.2},
	wear = 0,
})

minetest.register_tool("curwe:shield_tin", {
	description = "Tin Shield",
	inventory_image = "curwe_inv_shield_tin.png",
	groups = {armor_shield=5, armor_heal=0, armor_use=1750, armor_healing=0},
	wear = 0,
})

minetest.register_tool("curwe:shield_copper", {
	description = "Copper Shield",
	inventory_image = "curwe_inv_shield_copper.png",
	groups = {armor_shield=5, armor_heal=0, armor_use=1750, armor_healing=0},
	wear = 0,
})

minetest.register_tool("curwe:shield_steel", {
	description = "Steel Shield",
	inventory_image = "curwe_inv_shield_steel.png",
	groups = {armor_shield=10, armor_heal=0, armor_use=1250, armor_healing=0},
	wear = 0,
})

minetest.register_tool("curwe:shield_bronze", {
	description = "Bronze Shield",
	inventory_image = "curwe_inv_shield_bronze.png",
	groups = {armor_shield=12, armor_heal=6, armor_use=750, armor_healing=0},
	wear = 0,
})

minetest.register_tool("curwe:shield_silver", {
	description = "Silver Shield",
	inventory_image = "curwe_inv_shield_silver.png",
	groups = {armor_shield=15, armor_heal=6, armor_use=1000, armor_healing=0, physics_speed=-0.05},
	wear = 0,
})

minetest.register_tool("curwe:shield_gold", {
	description = "Gold Shield",
	inventory_image = "curwe_inv_shield_gold.png",
	groups = {armor_shield=15, armor_heal=12, armor_use=500, armor_healing=0, physics_speed=-0.05},
	wear = 0,
})

minetest.register_tool("curwe:shield_galvorn", {
	description = "Galvorn Shield",
	inventory_image = "curwe_inv_shield_galvorn.png",
	groups = {armor_shield=15, armor_heal=12, armor_use=250, armor_healing=0, physics_speed=-0.1, physics_sneak=-1, forbidden=1},
	wear = 0,
})

minetest.register_tool("curwe:shield_mithril", {
	description = "Mithril Shield",
	inventory_image = "curwe_inv_shield_mithril.png",
