...
armor = {
	...
	formspec = "size[8,8.5]" .. gui_bg_img .. gui_slots .."image[0,0;1,1;curwe_helmet.png]"
          .."image[3,0;1,1;curwe_helmet.png]"
          .."image[0,1;1,1;curwe_chestplate.png]"
          .."image[0,2;1,1;curwe_leggings.png]"
          .."image[0,3;1,1;curwe_boots.png]"
          .."image[3,1;1,1;curwe_shirt.png]"
          .."image[3,2;1,1;curwe_pants.png]"
          .."image[3,3;1,1;curwe_shoes.png]"
          ...
          .."image[2,2;1,1;curwe_shield.png]"
		.."list[current_player;main;0,4.25;8,1;]"
		.."list[current_player;main;0,5.5;8,3;8]"
          .."image[4.05,0;4.5,1;curwe_crafting.png]"
    	     .."list[current_player;craft;4,1;3,3;]"
    	     .."list[current_player;craftpreview;7,2;1,1;]"
          .."image[7,3;1,1;curwe_trash.png]"
...
armor.set_player_armor = function(self, player)
	...
	local armor_texture = "curwe_trans.png"
	local armor_level = 0
	local armor_heal = 0
	...
	if minetest.get_modpath("curwe") then
...
default.player_register_model("curwe_character.x", {
	animation_speed = 30,
	textures = {
...
minetest.register_on_joinplayer(function(player)
	default.player_set_model(player, "curwe_character.x")
	local name = player:get_player_name()
	local player_inv = player:get_inventory()
	...
	armor.textures[name] = {
		...
		armor = "curwe_trans.png",
		wielditem = "curwe_trans.png",
