...
npcf:register_tnpc("kelvar:dwarven_guard" ,{
	description = "Dwarven Guard",
	mesh = "dwarf_model.x",
	textures = {"kelvar_dwarf.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "kelvar_inv_dwarvenguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "curwe:steel_battleaxe",
