...
npcf:register_npc("kelvar:orc_guard" ,{
	description = "Orc Guard",
	mesh = "npcf_guard.x",
	textures = {"kelvar_orc.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "kelvar_inv_orcguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "curwe:orc_sword",
