...
npcf:register_npc("kelvar:uruk_hai_guard" ,{
	description = "Uruk Hai Guard",
	mesh = "npcf_guard.x",
	textures = {"kelvar_uruk_hai.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "kelvar_inv_urukhaiguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "curwe:steel_warhammer",
		blacklist = "kelvar:chicken kelvar:dwarf kelvar:elf kelvar:ent kelvar:gondor_guard kelvar:hobbit kelvar:rohan_guard kelvar:rohan_guard kelvar:gondor_guard kelvar:elven_guard kelvar:dwarven_guard",
		whitelist = "",
