...
npcf:register_wnpc("kelvar:elven_guard" ,{
	description = "Elven Guard",
	mesh = "elf_model.x",
	textures = {"kelvar_elf.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "kelvar_inv_elfguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "curwe:elven_sword",
