...
zfc.formspec = function(pn)
	...
	page = zfc.users[pn].page
	alt = zfc.users[pn].alt
	current_item = zfc.users[pn].current_item
...
minetest.register_tool("gul:forbidden_crafts_book",{
    description = "Book of Forbidden Crafts",
    inventory_image = "gul_forbidden_book.png",
    wield_image = "",
