...
local get_formspec = function(player,page)
	if page=="brews" then
		return "size[8,5.5]"
               ...
               .."item_image_button[4,2;1,1;gul:drinking_glass_water;zcg:vessels:glass_water;]"
               .."item_image_button[5,2;1,1;olvar:berries;zcg:berries;5]"
               .."image[6,1;1,1;zcg_craft_arrow.png]"
               .."item_image_button[7,2;1,1;gul:wine;zcg:wine;]"
               --Second 
               .."label[1,3.2; Beer (Method:Brewing)]"
               .."item_image_button[4,3;1,1;gul:drinking_glass_water;zcg:drinking_glass_water;]"
               .."item_image_button[5,3;1,1;farming:wheat;zcg:wheat;3]"
               .."image[6,3;1,1;zcg_craft_arrow.png]"
               .."item_image_button[7,3;1,1;gul:beer;zcg:beer;]"
               --Third
               .."label[1,4.2; Mead (Method:Brewing)]"
               .."item_image_button[4,4;1,1;gul:drinking_glass_water;zcg:drinking_glass_water;]"
               .."item_image_button[5,4;1,1;olvar:honey;zcg:honey;6]"
               .."image[6,4;1,1;zcg_craft_arrow.png]"
               .."item_image_button[7,4;1,1;gul:mead;zcg:mead;]"
     end
     if page=="brews2" then
		return "size[8,5.5]"
               .."background[5,5;1,1;gui_formbg.png;true]"
               ...
               .."item_image_button[4,2;1,1;gul:drinking_glass_water;zcg:drinking_glass_water;]"
               .."item_image_button[5,2;1,1;default:apple;zcg:apple; 5]"
               .."image[6,2;1,1;zcg_craft_arrow.png]"
               .."item_image_button[7,2;1,1;gul:cider;zcg:cider;]"
               --Second
               .."label[1,3.2; Ale (Method:Brewing)]"
               .."item_image_button[4,3;1,1;gul:drinking_glass_water;zcg:drinking_glass_water;]"
               .."item_image_button[5,3;1,1;olvar:barley;zcg:barley;6]"
               .."image[6,3;1,1;zcg_craft_arrow.png]"
               .."item_image_button[7,3;1,1;gul:ale;zcg:ale;]"
               --Third
...
minetest.register_tool("gul:brewing_book",{
    description = "Book of Brewing",
    inventory_image = "gul_brewing_book.png",
    wield_image = "",
