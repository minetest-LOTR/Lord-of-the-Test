...
if n.name == "olvar:turnips_1" then
	minetest.env:set_node(pos, {name="olvar:turnips_2"})
elseif n.name == "olvar:turnips_2" then
	minetest.env:set_node(pos, {name="olvar:turnips_3"})
elseif n.name == "olvar:turnips_3" then
	minetest.env:set_node(pos, {name="olvar:turnips_4"})
elseif n.name == "olvar:athelas_1" then
	minetest.env:set_node(pos, {name="olvar:athelas_2"})
elseif n.name == "olvar:athelas_2" then
	minetest.env:set_node(pos, {name="olvar:athelas_3"})
elseif n.name == "olvar:barley_1" then
	minetest.env:set_node(pos, {name="olvar:barley_2"})
elseif n.name == "olvar:barley_2" then
	minetest.env:set_node(pos, {name="olvar:barley_3"})
elseif n.name == "olvar:berries_1" then
	minetest.env:set_node(pos, {name="olvar:berries_2"})
elseif n.name == "olvar:berries_2" then
	minetest.env:set_node(pos, {name="olvar:berries_3"})
elseif n.name == "olvar:berries_3" then
	minetest.env:set_node(pos, {name="olvar:berries_4"})
elseif n.name == "olvar:blue_mushroom_1" then
	minetest.env:set_node(pos, {name="olvar:blue_mushroom_2"})
elseif n.name == "olvar:blue_mushroom_2" then
	minetest.env:set_node(pos, {name="olvar:blue_mushroom_3"})
elseif n.name == "olvar:blue_mushroom_3" then
	minetest.env:set_node(pos, {name="olvar:blue_mushroom_4"})
elseif n.name == "olvar:brown_mushroom_1" then
	minetest.env:set_node(pos, {name="olvar:brown_mushroom_2"})
elseif n.name == "olvar:brown_mushroom_2" then
	minetest.env:set_node(pos, {name="olvar:brown_mushroom_3"})
elseif n.name == "olvar:brown_mushroom_3" then
	minetest.env:set_node(pos, {name="olvar:brown_mushroom_4"})
elseif n.name == "olvar:cabbage_1" then
	minetest.env:set_node(pos, {name="olvar:cabbage_2"})
elseif n.name == "olvar:cabbage_2" then
	minetest.env:set_node(pos, {name="olvar:cabbage_3"})
elseif n.name == "olvar:green_mushroom_1" then
	minetest.env:set_node(pos, {name="olvar:green_mushroom_2"})
elseif n.name == "olvar:green_mushroom_2" then
	minetest.env:set_node(pos, {name="olvar:green_mushroom_3"})
elseif n.name == "olvar:green_mushroom_3" then
	minetest.env:set_node(pos, {name="olvar:green_mushroom_4"})
elseif n.name == "olvar:melon_1" then
	minetest.env:set_node(pos, {name="olvar:melon_2"})
elseif n.name == "olvar:melon_2" then
	minetest.env:set_node(pos, {name="olvar:melon_3"})
elseif n.name == "olvar:pipeweed_1" then
	minetest.env:set_node(pos, {name="olvar:pipeweed_2"})
elseif n.name == "olvar:pipeweed_2" then
	minetest.env:set_node(pos, {name="olvar:pipeweed_3"})
elseif n.name == "olvar:pipeweed_3" then
	minetest.env:set_node(pos, {name="olvar:pipeweed_4"})
elseif n.name == "olvar:potato_1" then
	minetest.env:set_node(pos, {name="olvar:potato_2"})
elseif n.name == "olvar:potato_2" then
	minetest.env:set_node(pos, {name="olvar:potato_3"})
elseif n.name == "olvar:red_mushroom_1" then
	minetest.env:set_node(pos, {name="olvar:red_mushroom_2"})
elseif n.name == "olvar:red_mushroom_2" then
	minetest.env:set_node(pos, {name="olvar:red_mushroom_3"})
elseif n.name == "olvar:red_mushroom_3" then
	minetest.env:set_node(pos, {name="olvar:red_mushroom_4"})
elseif n.name == "olvar:tomatoes_1" then
	minetest.env:set_node(pos, {name="olvar:tomatoes_2"})
elseif n.name == "olvar:tomatoes_2" then
	minetest.env:set_node(pos, {name="olvar:tomatoes_3"})
elseif n.name == "olvar:tomatoes_3" then
	minetest.env:set_node(pos, {name="olvar:tomatoes_4"})
elseif n.name == "olvar:corn_1" then
	minetest.env:set_node(pos, {name="olvar:corn_2"})
elseif n.name == "olvar:corn_2" then
	minetest.env:set_node(pos, {name="olvar:corn_21"})
elseif n.name == "olvar:corn_21" then
