...
npcf:register_npc("lottnpc:uruk_hai_guard" ,{
	description = "Uruk Hai Guard",
	mesh = "npcf_guard.x",
	textures = {"lottmobs_uruk_hai.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "lottnpc_inv_urukhaiguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "lottweapons:steel_warhammer",
		blacklist = "lottmobs:chicken lottmobs:dwarf lottmobs:elf lottmobs:ent lottmobs:gondor_guard lottmobs:hobbit lottmobs:rohan_guard lottnpc:rohan_guard lottnpc:gondor_guard lottnpc:elven_guard lottnpc:dwarven_guard",
		whitelist = "",
