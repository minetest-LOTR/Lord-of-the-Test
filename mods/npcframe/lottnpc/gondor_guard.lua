...
npcf:register_npc("lottnpc:gondor_guard" ,{
	description = "Gondor Guard",
	mesh = "npcf_guard.x",
	textures = {"lottmobs_gondor_guard.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "lottnpc_inv_gondorguard.png",
	stepheight = 1,
	metadata = {
