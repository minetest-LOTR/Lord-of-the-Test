...
npcf:register_npc("lottnpc:orc_guard" ,{
	description = "Orc Guard",
	mesh = "npcf_guard.x",
	textures = {"lottmobs_orc.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "lottnpc_inv_orcguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "lottweapons:orc_sword",
