...
npcf:register_tnpc("lottnpc:dwarven_guard" ,{
	description = "Dwarven Guard",
	mesh = "dwarf_model.x",
	textures = {"lottmobs_dwarf.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "lottnpc_inv_dwarvenguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "lottweapons:steel_battleaxe",
		blacklist = "lottmobs:balrog lottmobs:battle_troll lottmobs:dead_men lottmobs:dunlending lottmobs:half_troll lottmobs:nazgul lottmobs:orc lottmobs:spider lottmobs:troll lottmobs:uruk_hai lottmobs:witch_king lottnpc:orc_guard lottnpc:uruk_hai_guard",
		whitelist = "",
