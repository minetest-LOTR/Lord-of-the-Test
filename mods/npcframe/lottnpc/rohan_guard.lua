...
npcf:register_npc("lottnpc:rohan_guard" ,{
	description = "Rohan Guard",
	mesh = "npcf_guard.x",
	textures = {"lottmobs_rohan_guard.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "lottnpc_inv_rohanguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "lottweapons:steel_spear",
