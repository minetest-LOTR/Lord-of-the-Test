...
npcf:register_wnpc("lottnpc:elven_guard" ,{
	description = "Elven Guard",
	mesh = "elf_model.x",
	textures = {"lottmobs_elf.png", "npcf_skin_armor.png", "npcf_trans.png"},
	nametag_color = "red",
	inventory_image = "lottnpc_inv_elfguard.png",
	stepheight = 1,
	metadata = {
		wielditem = "lottweapons:elven_sword",
