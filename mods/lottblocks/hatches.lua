...
local function punch(pos)
	...
	oben = {x=pos.x, y=pos.y+1, z=pos.z}
		if state == 1 then
			state = 0
			minetest.sound_play("door_close", {pos = pos, gain = 0.3, max_hear_distance = 10})
			tmp_node = {name="lottblocks:hatch_junglewood", param1=me.param1, param2=me.param2}
		else
			state = 1
			minetest.sound_play("door_open", {pos = pos, gain = 0.3, max_hear_distance = 10})
			tmp_node = {name="lottblocks:hatch_junglewood_open", param1=me.param1, param2=me.param2}
		end
		update_door(pos, tmp_node)
		meta:set_int("state", state)
end

minetest.register_node("lottblocks:hatch_junglewood", {
	description = "Junglewood Hatch",
	drawtype = "nodebox",
	tiles = {"lottblocks_hatch_junglewood.png", "lottblocks_hatch_junglewood.png",  "lottblocks_hatch_side.png",  "lottblocks_hatch_side.png", "lottblocks_hatch_side.png", "lottblocks_hatch_side.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	groups = {choppy=2,flammable=2,door=1},
	sounds = default.node_sound_wood_defaults(),
...
minetest.register_node("lottblocks:hatch_junglewood_open", {
	drawtype = "nodebox",
	tiles = {"lottblocks_hatch_side.png", "lottblocks_hatch_side.png",  "lottblocks_hatch_side.png",  "lottblocks_hatch_side.png", "lottblocks_hatch_junglewood_open.png", "lottblocks_hatch_junglewood_open.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	pointable = true,
	stack_max = 0,
	...
	climbable = true,
	sounds = default.node_sound_wood_defaults(),
	drop = "lottblocks:hatch_junglewood",
	node_box = {
		type = "fixed",
		fixed = {-0.5, -0.5, 0.4, 0.5, 0.5, 0.5}
	},
...
minetest.register_craft({
	output = 'lottblocks:hatch_junglewood',
	recipe = {
...
local function punch(pos)
	...
	oben = {x=pos.x, y=pos.y+1, z=pos.z}
		if state == 1 then
			state = 0
			minetest.sound_play("door_close", {pos = pos, gain = 0.3, max_hear_distance = 10})
			tmp_node = {name="lottblocks:hatch_pine", param1=me.param1, param2=me.param2}
		else
			state = 1
			minetest.sound_play("door_open", {pos = pos, gain = 0.3, max_hear_distance = 10})
			tmp_node = {name="lottblocks:hatch_pine_open", param1=me.param1, param2=me.param2}
		end
		update_door(pos, tmp_node)
		meta:set_int("state", state)
end

minetest.register_node("lottblocks:hatch_pine", {
	description = "Pine Hatch",
	drawtype = "nodebox",
	tiles = {"lottblocks_hatch_pinewood.png", "lottblocks_hatch_pinewood.png",  "lottblocks_hatch_side.png",  "lottblocks_hatch_side.png", "lottblocks_hatch_side.png", "lottblocks_hatch_side.png"},
	paramtype = "light",
	paramtype2 = "facedir",
...
minetest.register_node("lottblocks:hatch_pine_open", {
	drawtype = "nodebox",
	tiles = {"lottblocks_hatch_side.png", "lottblocks_hatch_side.png",  "lottblocks_hatch_side.png",  "lottblocks_hatch_side.png", "lottblocks_hatch_pinewood_open.png", "lottblocks_hatch_pinewood_open.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	pointable = true,
	stack_max = 0,
