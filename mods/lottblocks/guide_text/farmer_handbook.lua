return "return {[\"background\"] = \"gui_hobbitbg.png\", [\"title\"] = \"Hobbits and Farming and Foods\", [\"owner\"] = \"A Hobbit Farmer\"," ..
	...
	"\\\nIt's good for everything! When you're at home, in a party, meeting up with friends, in a gathering."..
	"\\\nThere's no occasion which some food would spoil!"..
	...
	"\\\nSimply rightclick on any piece of dirt or grass while wielding the hoe."..
	"\\\nThe dirt or grass should turn into a piece of farmland."..
	"\\\n"..
	"\\\nNext make sure the farmland is wet."..
	"\\\nIf it is wet enough, the farmland should turn darker."..
	"\\\nIf it doesn't turn any darker, simply add some water nearby."..
	"\\\n"..
	"\\\nHaving the wet farmland, you can now place your seeds on top."..
	"\\\nBe patient and they will start growing."..
	"\\\nAnd after soon, you will get your very first harvest!"..
	"\\\n"..
	"\\\nTypes of Crops"..
	"\\\n--------------------------------------------------------------------" ..
	"\\\nThere are many foods you can farm, some of which are more filling than others."..
	"\\\n "..
	"\\\nFrom my years of experience, here's a list of foods, from the least filling to most filling food, some of which need to be cooked before they can be eaten:"..
	"\\\n - Berries"..
	"\\\n - Raw Potato"..
	"\\\n - Cooked Barley"..
	"\\\n - Slice of Melon"..
	...
	"\\\n - Cooked Potato"..
	"\\\n"..
	"\\\nYou can of course craft more complex food with some of these, which makes them even taster and more filling!"..
