return "return {[\"background\"] = \"gui_gondorbg.png\", [\"title\"] = \"Guarded Lands\", [\"owner\"] = \"An Explorer\"," ..
	...
	"\\\nIntroduction"..
	"\\\n--------------------------------------------------------------------" ..
	"\\\nThis is volume two of three of a work which documents my travels through Middle Earth." ..
	"\\\nThis volume records my venture through the regions of Middle Earth which are more guarded, and inhabited by more cautious people."..
	...
	"\\\nIthilien"..
	"\\\n--------------------------------------------------------------------" ..
	"\\\nA grassland forest filled with a variety of flora and fauna."..
	"\\\nThe land is mostly void of inhabitants except for the occasional Ithilien ranger, a member of a group of people who attempt to guard this empty land."..
	...
	"\\\nGondor"..
	"\\\n--------------------------------------------------------------------" ..
	"\\\nThe ancient kingdom of men."..
	"\\\nHere there are mostly plains with the occasional tree."..
	"\\\nGreat white Gondorian forts decorate the region. Serving as protection against frequent raids from the orcs."..
	...
	"\\\nHorses gallop over these great grassland plains, with the occasional Rohirrim soldier patrolling by."..
	"\\\nSmall wooden forts can be spotted occasionally, guarding the land against the attacks of the enemy."..
	"\\\nFauna and flora are mostly scarce, as a result of the hot sun scorching the land."..
	"\\\nAt night, some raiding orcs wander into the region, so watch your back."..
	"\\\nBrown withered grass is found in this region, but there are occasional patches of green."..
	"\\\nScorched red desert stone is also found on cliff faces instead of normal stone, perhaps a portent of the future of this land."..
	"\\\n "..
	"\\\nFangorn"..
	"\\\n--------------------------------------------------------------------" ..
