return "return {[\"background\"] = \"gui_brewerbg.png\", [\"title\"] = \"Making Brews\", [\"owner\"] = \"A Hobbit Brewer\"," ..
	...
	"\\\nW, S, W"..
	"\\\n "..
	"\\\nNext, you need a cauldron barrel to contain all the water for your brews."..
	"\\\nCraft one like this;"..
	"\\\nS = Steel Ingot / N = Nothing"..
	"\\\nS, N, S"..
	"\\\nS, N, S"..
	"\\\nS, S, S"..
	"\\\n "..
	"\\\nFinally, you need a book of brewing."..
	"\\\nThe book of brewing will provide you with recipes on how to create all these wonderous beverages."..
	"\\\nBorrow one from your local Hobbiton library or simply make one!"..
	...
	"\\\nAnd with that, simply follow the recipe as stated in the book of brewing to get what you want!"..
	"\\\n "..
	"\\\nHappy brewing! Don't get too drunk!\"}"
