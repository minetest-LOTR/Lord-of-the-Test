minetest.register_craftitem("lottthrowing:arrow_fire", {
	description = "Fire Arrow",
	inventory_image = "lottthrowing_arrow_fire.png",
})

minetest.register_node("lottthrowing:arrow_fire_box", {
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
		fixed = {
	...
	tiles = {"lottthrowing_arrow_fire.png", "lottthrowing_arrow_fire.png", "lottthrowing_arrow_fire_back.png", "lottthrowing_arrow_fire_front.png", "lottthrowing_arrow_fire_2.png", "lottthrowing_arrow_fire.png"},
...
local THROWING_ARROW_ENTITY={
	...
	textures = {"lottthrowing:arrow_fire_box"},
	lastpos={},
	...
	if self.timer>0.2 then
		...
		for k, obj in pairs(objs) do
			if obj:get_luaentity() ~= nil then
				if obj:get_luaentity().name ~= "lottthrowing:arrow_fire_entity" and obj:get_luaentity().name ~= "__builtin:item" then
					local damage = 5
...
minetest.register_entity("lottthrowing:arrow_fire_entity", THROWING_ARROW_ENTITY)
