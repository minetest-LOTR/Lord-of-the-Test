...
local function on_flood(pos, oldnode, newnode)
	minetest.add_item(pos, ItemStack("lottitems:torch 1"))
	return false
end
...
minetest.register_node("lottitems:torch", {
	...
	inventory_image = "lottitems_torch_on_floor.png",
	wield_image = "lottitems_torch_on_floor.png",
	tiles = {{
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		itemstack:set_name("lottitems:torch")
...
minetest.register_node("lottitems:torch_wall", {
	drawtype = "mesh",
	mesh = "lottitems_torch_wall.obj",
	tiles = {{
		    name = "lottitems_torch_on_floor_animated.png",
		    animation = {type = "vertical_frames", aspect_w = 16, aspect_h = 16, length = 3.3}
	}},
